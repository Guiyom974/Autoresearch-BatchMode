# Research Problem: Fractals - Menger Sponge - Volume

## Objective
Investigate the volume and surface area scaling ratios of a Menger sponge construction up to 10 iterations.
...
## Methodology
1. **Data Generation**: Implement a simulation or generate a synthetic dataset representing the Menger Sponge - Volume environment.

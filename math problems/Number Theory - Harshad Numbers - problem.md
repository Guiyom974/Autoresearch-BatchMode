# Research Problem: Number Theory - Harshad Numbers

## Objective
Investigate the density of Harshad numbers (divisible by sum of digits) in base 10 up to 10^6.
...
## Methodology
1. **Data Generation**: Implement a simulation or generate a synthetic dataset representing the Harshad Numbers environment.

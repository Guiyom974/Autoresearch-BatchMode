# Research Problem: Fractals - Peter de Jong Attractor

## Objective
Investigate the structural symmetry variations and correlation dimensions in Peter de Jong attractors.
...
## Methodology
1. **Data Generation**: Implement a simulation or generate a synthetic dataset representing the Peter de Jong Attractor environment.

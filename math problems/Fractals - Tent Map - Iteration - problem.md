# Research Problem: Fractals - Tent Map - Iteration

## Objective
Investigate the invariant density and deterministic diffusion properties within the chaotic regime of the Tent map.
...
## Methodology
1. **Data Generation**: Implement a simulation or generate a synthetic dataset representing the Tent Map - Iteration environment.

# Research Problem: Constants - Pi Digits - Pairs

## Objective
Investigate the frequency of digit pairs (00 to 99) in the first 10^6 digits of Pi.
...
## Methodology
1. **Data Generation**: Implement a simulation or generate a synthetic dataset representing the Pi Digits - Pairs environment.

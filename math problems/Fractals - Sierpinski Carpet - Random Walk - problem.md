# Research Problem: Fractals - Sierpinski Carpet - Random Walk

## Objective
Investigate the escape time and diffusion metrics for a random walk constrained within a Sierpinski Carpet lattice.
...
## Methodology
1. **Data Generation**: Implement a simulation or generate a synthetic dataset representing the Sierpinski Carpet - Random Walk environment.

# Research Problem: Prime Numbers - Legendre's Conjecture

## Objective
Investigate the number of primes situated between n^2 and (n+1)^2 for n up to 10^4.
...
## Methodology
1. **Data Generation**: Implement a simulation or generate a synthetic dataset representing the Legendre's Conjecture environment.

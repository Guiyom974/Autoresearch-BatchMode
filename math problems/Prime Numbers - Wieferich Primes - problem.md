# Research Problem: Prime Numbers - Wieferich Primes

## Objective
Investigate the occurrence and modular properties related to Wieferich condition (p^2 divides 2^(p-1) - 1) up to 10^6.
...
## Methodology
1. **Data Generation**: Implement a simulation or generate a synthetic dataset representing the Wieferich Primes environment.

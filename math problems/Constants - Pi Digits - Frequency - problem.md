# Research Problem: Constants - Pi Digits - Frequency

## Objective
Investigate the uniformity (Normality) of digits 0-9 in the first 10^6 digits of Pi.
...
## Methodology
1. **Data Generation**: Implement a simulation or generate a synthetic dataset representing the Pi Digits - Frequency environment.

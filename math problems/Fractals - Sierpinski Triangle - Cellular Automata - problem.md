# Research Problem: Fractals - Sierpinski Triangle - Cellular Automata

## Objective
Investigate the statistical equivalence and entropy matching between Rule 90 cellular automata and the Sierpinski Triangle.
...
## Methodology
1. **Data Generation**: Implement a simulation or generate a synthetic dataset representing the Sierpinski Triangle - Cellular Automata environment.

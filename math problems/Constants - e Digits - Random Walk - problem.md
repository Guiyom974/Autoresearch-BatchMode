# Research Problem: Constants - e Digits - Random Walk

## Objective
Investigate the 2D random walk generated by the digits of e mapped to Cartesian directions.
...
## Methodology
1. **Data Generation**: Implement a simulation or generate a synthetic dataset representing the e Digits - Random Walk environment.

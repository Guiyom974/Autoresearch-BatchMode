# Research Problem: Number Theory - Perfect Numbers

## Objective
Investigate the properties of the sum of proper divisors and abundance index for integers up to 10^6.
...
## Methodology
1. **Data Generation**: Implement a simulation or generate a synthetic dataset representing the Perfect Numbers environment.

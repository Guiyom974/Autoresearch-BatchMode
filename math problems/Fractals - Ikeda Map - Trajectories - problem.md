# Research Problem: Fractals - Ikeda Map - Trajectories

## Objective
Investigate the fractal dimension and chaos boundaries of trajectory clouds in the Ikeda map.
...
## Methodology
1. **Data Generation**: Implement a simulation or generate a synthetic dataset representing the Ikeda Map - Trajectories environment.

# Research Problem: Fractals - Lorenz Attractor - Dimension

## Objective
Investigate the correlation dimension characterizing the Lorenz strange attractor.
...
## Methodology
1. **Data Generation**: Implement a simulation or generate a synthetic dataset representing the Lorenz Attractor - Dimension environment.

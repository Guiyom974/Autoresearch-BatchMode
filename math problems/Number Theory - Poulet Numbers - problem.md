# Research Problem: Number Theory - Poulet Numbers

## Objective
Investigate the occurrence of Fermat pseudoprimes to base 2 up to 10^6.
...
## Methodology
1. **Data Generation**: Implement a simulation or generate a synthetic dataset representing the Poulet Numbers environment.

# Research Problem: Number Theory - Carmichael Numbers

## Objective
Investigate the frequency of Carmichael numbers relative to prime numbers up to 10^6.
...
## Methodology
1. **Data Generation**: Implement a simulation or generate a synthetic dataset representing the Carmichael Numbers environment.

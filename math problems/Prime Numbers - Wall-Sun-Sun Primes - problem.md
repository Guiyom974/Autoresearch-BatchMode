# Research Problem: Prime Numbers - Wall-Sun-Sun Primes

## Objective
Investigate the modular properties of the Fibonacci sequence related to Wall-Sun-Sun primes up to 10^6.
...
## Methodology
1. **Data Generation**: Implement a simulation or generate a synthetic dataset representing the Wall-Sun-Sun Primes environment.

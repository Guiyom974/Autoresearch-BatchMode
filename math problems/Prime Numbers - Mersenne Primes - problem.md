# Research Problem: Prime Numbers - Mersenne Primes

## Objective
Investigate the deterministic distribution and divisibility properties of Mersenne numbers (2^p - 1) up to p=10^4.
...
## Methodology
1. **Data Generation**: Implement a simulation or generate a synthetic dataset representing the Mersenne Primes environment.

# Research Problem: Prime Numbers - Andrica's Conjecture

## Objective
Investigate the maximum value of sqrt(p_{n+1}) - sqrt(p_n) up to p_n = 10^7.
...
## Methodology
1. **Data Generation**: Implement a simulation or generate a synthetic dataset representing the Andrica's Conjecture environment.

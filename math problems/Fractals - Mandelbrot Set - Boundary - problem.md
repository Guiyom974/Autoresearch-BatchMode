# Research Problem: Fractals - Mandelbrot Set - Boundary

## Objective
Investigate the box-counting dimension and roughness of the Mandelbrot set boundary.
...
## Methodology
1. **Data Generation**: Implement a simulation or generate a synthetic dataset representing the Mandelbrot Set - Boundary environment.

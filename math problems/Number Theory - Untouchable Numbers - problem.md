# Research Problem: Number Theory - Untouchable Numbers

## Objective
Investigate numbers that cannot be expressed as the sum of proper divisors of any integer up to 10^5.
...
## Methodology
1. **Data Generation**: Implement a simulation or generate a synthetic dataset representing the Untouchable Numbers environment.

# Research Problem: Prime Numbers - Wilson Primes

## Objective
Investigate the occurrence and modular properties related to Wilson condition (p^2 divides (p-1)! + 1) up to 10^5.
...
## Methodology
1. **Data Generation**: Implement a simulation or generate a synthetic dataset representing the Wilson Primes environment.

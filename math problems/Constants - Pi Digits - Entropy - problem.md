# Research Problem: Constants - Pi Digits - Entropy

## Objective
Investigate the Shannon entropy measurements of sliding windows over Pi's digits to evaluate randomness.
...
## Methodology
1. **Data Generation**: Implement a simulation or generate a synthetic dataset representing the Pi Digits - Entropy environment.

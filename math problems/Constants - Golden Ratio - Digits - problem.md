# Research Problem: Constants - Golden Ratio - Digits

## Objective
Investigate the digit distribution (Normality tests) in the first 10^6 digits of Phi.
...
## Methodology
1. **Data Generation**: Implement a simulation or generate a synthetic dataset representing the Golden Ratio - Digits environment.

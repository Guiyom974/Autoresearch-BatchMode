# Research Problem: Systems - Inventory Management

## Objective
Simulate the Economic Order Quantity (EOQ) model under 'uncertain demand' and calculate the required 'safety stock' level.
...
## Methodology
1. **Data Generation**: Implement a simulation or generate a synthetic dataset representing the Inventory Management environment.

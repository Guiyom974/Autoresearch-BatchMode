# Research Problem: Financial - Efficient Market Hypothesis

## Objective
Test various technical analysis indicators (RSI/MACD) on 10^5 random walk price paths to find false positive signals.
...
## Methodology
1. **Data Generation**: Implement a simulation or generate a synthetic dataset representing the Efficient Market Hypothesis environment.

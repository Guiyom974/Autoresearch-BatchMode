# Research Problem: Game Theory - Public Goods Game

## Objective
Model the impact of 'social punishment' on the level of contribution in a community resource pool.
...
## Methodology
1. **Data Generation**: Implement a simulation or generate a synthetic dataset representing the Public Goods Game environment.

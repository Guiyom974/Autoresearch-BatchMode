# Research Problem: Optimization - Pathfinding Efficiency

## Objective
Compare the 'A*' algorithm vs Dijkstra for pathfinding on a dynamic grid with moving obstacles.
...
## Methodology
1. **Data Generation**: Implement a simulation or generate a synthetic dataset representing the Pathfinding Efficiency environment.

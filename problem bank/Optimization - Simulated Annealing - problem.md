# Research Problem: Optimization - Simulated Annealing

## Objective
Determine the optimal 'cooling schedule' (Linear vs Exponential) for solving a complex Scheduling Problem.
...
## Methodology
1. **Data Generation**: Implement a simulation or generate a synthetic dataset representing the Simulated Annealing environment.

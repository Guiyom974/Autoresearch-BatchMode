# Research Problem: Network Theory - Small World Networks

## Objective
Measure the average path length and clustering coefficient as a function of the 're-wiring' probability p in a Watts-Strogatz model.
...
## Methodology
1. **Data Generation**: Implement a simulation or generate a synthetic dataset representing the Small World Networks environment.

# Research Problem: Game Theory - Auction Theory

## Objective
Compare the final price and 'revenue' of First-Price vs Second-Price (Vickrey) auctions with 'Shill' bidders.
...
## Methodology
1. **Data Generation**: Implement a simulation or generate a synthetic dataset representing the Auction Theory environment.

# Research Problem: Financial - Geometric Brownian Motion

## Objective
Test the accuracy of GBM in predicting price paths for high-volatility assets vs stable assets.
...
## Methodology
1. **Data Generation**: Implement a simulation or generate a synthetic dataset representing the Geometric Brownian Motion environment.

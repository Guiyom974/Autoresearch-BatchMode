# Research Problem: Physics - Schrodinger's Cat

## Objective
Simulated 'quantum' state collapse: model the effects of decoherence rate on the probability of 'state survival'.
...
## Methodology
1. **Data Generation**: Implement a simulation or generate a synthetic dataset representing the Schrodinger's Cat environment.

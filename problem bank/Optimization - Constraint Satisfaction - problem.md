# Research Problem: Optimization - Constraint Satisfaction

## Objective
Model the 'Sudoku Solver' as a backtracking problem and measure the time-complexity across puzzle difficulty levels.
...
## Methodology
1. **Data Generation**: Implement a simulation or generate a synthetic dataset representing the Constraint Satisfaction environment.

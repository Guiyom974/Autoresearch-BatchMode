# Research Problem: Ecology - Island Biogeography

## Objective
Model the 'Species-Area' relationship: measure how species richness scales with the size and isolation of simulated ecological islands.
...
## Methodology
1. **Data Generation**: Implement a simulation or generate a synthetic dataset representing the Island Biogeography environment.

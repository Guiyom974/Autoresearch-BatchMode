# Research Problem: Physics - Ising Model

## Objective
Simulate a 2D ferromagnetic Ising model and detect the 'Curie Temperature' where magnetization vanishes.
...
## Methodology
1. **Data Generation**: Implement a simulation or generate a synthetic dataset representing the Ising Model environment.

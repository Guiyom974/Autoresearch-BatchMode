# Research Problem: Financial - Fractal Market Hypothesis

## Objective
Measure the Hurst exponent of various global indices over 50 years to detect long-memory correlations.
...
## Methodology
1. **Data Generation**: Implement a simulation or generate a synthetic dataset representing the Fractal Market Hypothesis environment.

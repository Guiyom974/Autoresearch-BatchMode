# Research Problem: Physics - Diffusion-Limited Aggregation

## Objective
Analyze the fractal dimension of DLA clusters generated under various 'sticking' probability rules.
...
## Methodology
1. **Data Generation**: Implement a simulation or generate a synthetic dataset representing the Diffusion-Limited Aggregation environment.

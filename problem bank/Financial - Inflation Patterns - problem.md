# Research Problem: Financial - Inflation Patterns

## Objective
Analyze the correlation between commodity price peaks and currency devaluation using multi-lag analysis.
...
## Methodology
1. **Data Generation**: Implement a simulation or generate a synthetic dataset representing the Inflation Patterns environment.

# Research Problem: Financial - Economic Bubbles

## Objective
Model the 'herding' behavior in asset prices using a self-exciting point process (Hawkes process).
...
## Methodology
1. **Data Generation**: Implement a simulation or generate a synthetic dataset representing the Economic Bubbles environment.

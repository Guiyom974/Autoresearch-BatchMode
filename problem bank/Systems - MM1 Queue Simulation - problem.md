# Research Problem: Systems - MM1 Queue Simulation

## Objective
Measure the relationship between 'utilization' (rho) and the average waiting time in a single-server system.
...
## Methodology
1. **Data Generation**: Implement a simulation or generate a synthetic dataset representing the MM1 Queue Simulation environment.

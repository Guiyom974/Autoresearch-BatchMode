# Research Problem: Optimization - Genetic Algorithms

## Objective
Test the 'mutation rate' versus 'convergence speed' tradeoff for finding extremes in multimodal functions.
...
## Methodology
1. **Data Generation**: Implement a simulation or generate a synthetic dataset representing the Genetic Algorithms environment.

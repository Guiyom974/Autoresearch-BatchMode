# Research Problem: Ecology - Resource Depletion

## Objective
Simulate the 'Tragedy of the Commons' in a fishery and find the 'maximum sustainable yield' before collapse.
...
## Methodology
1. **Data Generation**: Implement a simulation or generate a synthetic dataset representing the Resource Depletion environment.

# Research Problem: Statistics - Law of Large Numbers

## Objective
Measure the 'convergence speed' of the average for different probability distributions (Cauchy vs Gaussian).
...
## Methodology
1. **Data Generation**: Implement a simulation or generate a synthetic dataset representing the Law of Large Numbers environment.

# Research Problem: Linguistics - Text Compression

## Objective
Compare the LZW vs Huffman compression efficiency for various natural vs artificial languages.
...
## Methodology
1. **Data Generation**: Implement a simulation or generate a synthetic dataset representing the Text Compression environment.

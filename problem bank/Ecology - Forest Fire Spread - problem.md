# Research Problem: Ecology - Forest Fire Spread

## Objective
Model the spread of fire on a grid using cellular automata and detect the 'percolation threshold' of tree density.
...
## Methodology
1. **Data Generation**: Implement a simulation or generate a synthetic dataset representing the Forest Fire Spread environment.

# Research Problem: Network Theory - Social Contagion

## Objective
Model the spread of information on a network using the 'Simple' vs 'Complex' contagion threshold rules.
...
## Methodology
1. **Data Generation**: Implement a simulation or generate a synthetic dataset representing the Social Contagion environment.

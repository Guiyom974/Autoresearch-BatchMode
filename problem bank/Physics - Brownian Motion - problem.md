# Research Problem: Physics - Brownian Motion

## Objective
Model the 'Random Walk' of particles and calculate the diffusion coefficient for different environment temperatures.
...
## Methodology
1. **Data Generation**: Implement a simulation or generate a synthetic dataset representing the Brownian Motion environment.

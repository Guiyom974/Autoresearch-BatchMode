# Research Problem: Linguistics - Grammatical Evolution

## Objective
Model the decay rate of irregular verbs in English over time using a simple reinforcement learning model.
...
## Methodology
1. **Data Generation**: Implement a simulation or generate a synthetic dataset representing the Grammatical Evolution environment.

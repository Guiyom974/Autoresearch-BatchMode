# Research Problem: Statistics - Monty Hall

## Objective
Extend the Monty Hall problem to N doors and K goats, simulating the optimal strategy under 'partial disclosure' rules.
...
## Methodology
1. **Data Generation**: Implement a simulation or generate a synthetic dataset representing the Monty Hall environment.

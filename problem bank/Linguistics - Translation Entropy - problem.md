# Research Problem: Linguistics - Translation Entropy

## Objective
Measure the entropy 'loss' when a text is translated back and forth through multiple languages (e.g., En -> Fr -> Ge -> En).
...
## Methodology
1. **Data Generation**: Implement a simulation or generate a synthetic dataset representing the Translation Entropy environment.

# Research Problem: Linguistics - Phonetic Similarity

## Objective
Measure the 'Levenshtein Distance' between common words in different Indo-European languages to map proximity.
...
## Methodology
1. **Data Generation**: Implement a simulation or generate a synthetic dataset representing the Phonetic Similarity environment.

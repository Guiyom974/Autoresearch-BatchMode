# Research Problem: Optimization - Linear Programming

## Objective
Optimize a factory's multi-resource production schedule using the Simplex method and sensitivity analysis.
...
## Methodology
1. **Data Generation**: Implement a simulation or generate a synthetic dataset representing the Linear Programming environment.

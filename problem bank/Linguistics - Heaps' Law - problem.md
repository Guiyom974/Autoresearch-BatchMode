# Research Problem: Linguistics - Heaps' Law

## Objective
Measure the growth of vocabulary (V) as a function of total words (N) in large corpora and fit the Heaps exponent.
...
## Methodology
1. **Data Generation**: Implement a simulation or generate a synthetic dataset representing the Heaps' Law environment.

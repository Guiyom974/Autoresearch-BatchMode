# Research Problem: Statistics - Null Hypothesis Testing

## Objective
Simulate a 'P-hacking' environment to measure how many false positives are generated across 10,000 random correlation tests.
...
## Methodology
1. **Data Generation**: Implement a simulation or generate a synthetic dataset representing the Null Hypothesis Testing environment.

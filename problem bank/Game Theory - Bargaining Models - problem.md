# Research Problem: Game Theory - Bargaining Models

## Objective
Model the Nash Bargaining Solution: find the split between two parties with different 'threat points' and patience levels.
...
## Methodology
1. **Data Generation**: Implement a simulation or generate a synthetic dataset representing the Bargaining Models environment.

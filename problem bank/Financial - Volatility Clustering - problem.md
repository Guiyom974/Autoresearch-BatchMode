# Research Problem: Financial - Volatility Clustering

## Objective
Simulate GARCH(1,1) processes and compare their volatility clustering with actual historical crypto data.
...
## Methodology
1. **Data Generation**: Implement a simulation or generate a synthetic dataset representing the Volatility Clustering environment.

# Research Problem: Statistics - Bayesian Inference

## Objective
Test the sensitivity of posterior probability to increasingly 'wrong' priors in a biased coin experiment.
...
## Methodology
1. **Data Generation**: Implement a simulation or generate a synthetic dataset representing the Bayesian Inference environment.

# Research Problem: Statistics - Simpson's Paradox

## Objective
Simulate a multi-variable dataset where the aggregate trend reverses in all sub-groups; detect the threshold of 'hidden variable' impact.
...
## Methodology
1. **Data Generation**: Implement a simulation or generate a synthetic dataset representing the Simpson's Paradox environment.

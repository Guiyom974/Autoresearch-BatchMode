# Research Problem: Financial - Black-Scholes Model

## Objective
Measure the sensitivity of the 'Greeks' (Delta/Gamma) under non-normal (fat-tailed) volatility distributions.
...
## Methodology
1. **Data Generation**: Implement a simulation or generate a synthetic dataset representing the Black-Scholes Model environment.

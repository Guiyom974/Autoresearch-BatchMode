# Research Problem: Game Theory - Congestion Games

## Objective
Model traffic flow where each driver chooses the fastest path, finding the total social cost compared to a centrally planned optimum.
...
## Methodology
1. **Data Generation**: Implement a simulation or generate a synthetic dataset representing the Congestion Games environment.

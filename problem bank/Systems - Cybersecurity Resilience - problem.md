# Research Problem: Systems - Cybersecurity Resilience

## Objective
Simulate the 'DDoS' attack resilience of a load balancer for different request filtering strategies.
...
## Methodology
1. **Data Generation**: Implement a simulation or generate a synthetic dataset representing the Cybersecurity Resilience environment.

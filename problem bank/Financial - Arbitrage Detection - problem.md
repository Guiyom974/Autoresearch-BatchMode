# Research Problem: Financial - Arbitrage Detection

## Objective
Simulate a multi-exchange triangular arbitrage environment and detect the 'decay rate' of profit opportunities.
...
## Methodology
1. **Data Generation**: Implement a simulation or generate a synthetic dataset representing the Arbitrage Detection environment.

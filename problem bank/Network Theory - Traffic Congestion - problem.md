# Research Problem: Network Theory - Traffic Congestion

## Objective
Model Braess's Paradox: show how adding a road to a network can increase total travel time.
...
## Methodology
1. **Data Generation**: Implement a simulation or generate a synthetic dataset representing the Traffic Congestion environment.

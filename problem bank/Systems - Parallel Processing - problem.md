# Research Problem: Systems - Parallel Processing

## Objective
Simulate Amdahl's Law: measure the speedup of a system as a function of the 'serial' vs 'parallel' proportion of code.
...
## Methodology
1. **Data Generation**: Implement a simulation or generate a synthetic dataset representing the Parallel Processing environment.

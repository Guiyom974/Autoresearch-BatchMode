# Research Problem: Optimization - Sorting Algorithm Performance

## Objective
Benchmark QuickSort vs MergeSort across 'nearly sorted' vs 'completely random' large datasets.
...
## Methodology
1. **Data Generation**: Implement a simulation or generate a synthetic dataset representing the Sorting Algorithm Performance environment.

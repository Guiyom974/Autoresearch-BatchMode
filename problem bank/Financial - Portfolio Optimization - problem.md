# Research Problem: Financial - Portfolio Optimization

## Objective
Test the Sharpe ratio of a 'Markowitz' optimized portfolio against a simple 'naive' 1/N allocation under stress.
...
## Methodology
1. **Data Generation**: Implement a simulation or generate a synthetic dataset representing the Portfolio Optimization environment.

# Research Problem: Optimization - Hash Function Collision

## Objective
Compare the collision rates of different hash functions (MD5 vs SHA-256 vs CRC32) for large string datasets.
...
## Methodology
1. **Data Generation**: Implement a simulation or generate a synthetic dataset representing the Hash Function Collision environment.

# Research Problem: Game Theory - Prisoner's Dilemma

## Objective
Benchmark the 'Tit-for-Tat' strategy against 'Tit-for-Two-Tats' and 'Always Defect' in a 1000-round tournament.
...
## Methodology
1. **Data Generation**: Implement a simulation or generate a synthetic dataset representing the Prisoner's Dilemma environment.

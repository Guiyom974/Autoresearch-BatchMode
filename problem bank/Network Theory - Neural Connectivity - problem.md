# Research Problem: Network Theory - Neural Connectivity

## Objective
Simulate a simple recurrent neural network and measure how 'synaptic' pruning affects signal transmission efficiency.
...
## Methodology
1. **Data Generation**: Implement a simulation or generate a synthetic dataset representing the Neural Connectivity environment.

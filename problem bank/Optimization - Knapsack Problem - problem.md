# Research Problem: Optimization - Knapsack Problem

## Objective
Compare the results of 'Greedy' approach vs 'Dynamic Programming' for large datasets with varying capacity ratios.
...
## Methodology
1. **Data Generation**: Implement a simulation or generate a synthetic dataset representing the Knapsack Problem environment.

# Research Problem: Game Theory - Zero-Sum Games

## Objective
Test the 'Minimax' strategy in an expanded Rock-Paper-Scissors-Lizard-Spock game with randomized strategies.
...
## Methodology
1. **Data Generation**: Implement a simulation or generate a synthetic dataset representing the Zero-Sum Games environment.

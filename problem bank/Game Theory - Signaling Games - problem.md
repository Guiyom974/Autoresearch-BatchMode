# Research Problem: Game Theory - Signaling Games

## Objective
Model the effectiveness of 'Costly Signaling' in a job market where candidates have hidden quality levels.
...
## Methodology
1. **Data Generation**: Implement a simulation or generate a synthetic dataset representing the Signaling Games environment.

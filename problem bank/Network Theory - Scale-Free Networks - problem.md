# Research Problem: Network Theory - Scale-Free Networks

## Objective
Test the robustness of Barabasi-Albert networks against random node failure vs targeted 'hub' attacks.
...
## Methodology
1. **Data Generation**: Implement a simulation or generate a synthetic dataset representing the Scale-Free Networks environment.

# Research Problem: Optimization - Traveling Salesman Problem

## Objective
Benchmark the Ant Colony Optimization (ACO) algorithm against Nearest Neighbor (NN) for N > 100 nodes.
...
## Methodology
1. **Data Generation**: Implement a simulation or generate a synthetic dataset representing the Traveling Salesman Problem environment.

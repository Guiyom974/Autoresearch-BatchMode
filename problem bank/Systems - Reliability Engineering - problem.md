# Research Problem: Systems - Reliability Engineering

## Objective
Model a 'k-out-of-n' redundant system and calculate the overall MTBF (Mean Time Between Failures).
...
## Methodology
1. **Data Generation**: Implement a simulation or generate a synthetic dataset representing the Reliability Engineering environment.

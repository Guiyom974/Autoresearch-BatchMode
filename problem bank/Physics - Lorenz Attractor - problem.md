# Research Problem: Physics - Lorenz Attractor

## Objective
Measure the 'Butterfly Effect': how quickly do two starting points diverge as a function of the initial epsilon delta?
...
## Methodology
1. **Data Generation**: Implement a simulation or generate a synthetic dataset representing the Lorenz Attractor environment.

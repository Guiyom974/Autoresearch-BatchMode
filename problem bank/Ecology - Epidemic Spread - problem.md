# Research Problem: Ecology - Epidemic Spread

## Objective
Model the SIR model phases based on the 'Contact Rate' and find the threshold for 'herd immunity' coverage.
...
## Methodology
1. **Data Generation**: Implement a simulation or generate a synthetic dataset representing the Epidemic Spread environment.

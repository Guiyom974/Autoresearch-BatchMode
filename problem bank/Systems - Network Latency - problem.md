# Research Problem: Systems - Network Latency

## Objective
Model the impact of 'packet loss' probability on the total file transfer time in a simulated TCP-like protocol.
...
## Methodology
1. **Data Generation**: Implement a simulation or generate a synthetic dataset representing the Network Latency environment.

# Research Problem: Financial - Market Microstructure

## Objective
Analyze the distribution of bid-ask spreads in simulated high-frequency environments with 'iceberg' orders.
...
## Methodology
1. **Data Generation**: Implement a simulation or generate a synthetic dataset representing the Market Microstructure environment.

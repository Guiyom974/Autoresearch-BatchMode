# Research Problem: Statistics - Birthday Paradox

## Objective
Generalize the Birthday Paradox to non-uniform birth distributions and measure the deviation from the classic formula.
...
## Methodology
1. **Data Generation**: Implement a simulation or generate a synthetic dataset representing the Birthday Paradox environment.

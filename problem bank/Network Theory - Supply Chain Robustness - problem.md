# Research Problem: Network Theory - Supply Chain Robustness

## Objective
Model the 'Bullwhip Effect' in a multi-tier supply chain network and detect propagation delays.
...
## Methodology
1. **Data Generation**: Implement a simulation or generate a synthetic dataset representing the Supply Chain Robustness environment.

# Research Problem: Game Theory - Evolutionary Stable Strategy

## Objective
Simulate a population of 'Hawks' and 'Doves' and find the stable ratio under varying 'cost of injury' (C) parameters.
...
## Methodology
1. **Data Generation**: Implement a simulation or generate a synthetic dataset representing the Evolutionary Stable Strategy environment.
